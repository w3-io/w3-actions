/* @ts-self-types="./w3_encode_wasm.d.ts" */
 ...
 * @returns {string}
 */
function hex_encode_prefixed(data) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.hex_encode_prefixed(ptr0, len0);
        deferred2_0 = ret[0];
        deferred2_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
...
exports.hex_encode_prefixed = hex_encode_prefixed;
...
const wasmPath = `${__dirname}/w3_encode_wasm_bg.wasm`;
