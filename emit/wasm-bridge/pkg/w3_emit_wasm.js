/* @ts-self-types="./w3_emit_wasm.d.ts" */
 ...
 * @returns {string}
 */
function prepare_event(name, payload_json, source, step, timestamp, secret) {
    let deferred8_0;
    let deferred8_1;
    try {
        ...
        const ptr3 = passStringToWasm0(step, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len3 = WASM_VECTOR_LEN;
        const ptr4 = passStringToWasm0(timestamp, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len4 = WASM_VECTOR_LEN;
        const ptr5 = passStringToWasm0(secret, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len5 = WASM_VECTOR_LEN;
        const ret = wasm.prepare_event(ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3, ptr4, len4, ptr5, len5);
        var ptr7 = ret[0];
        var len7 = ret[1];
        if (ret[3]) {
            ptr7 = 0; len7 = 0;
...
exports.prepare_event = prepare_event;
...
const wasmPath = `${__dirname}/w3_emit_wasm_bg.wasm`;
